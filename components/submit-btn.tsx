...
interface SubmitBtnProps {
  className?: string;
  disabled?: boolean; // ✅ Obsługa `disabled`
}

export default function SubmitBtn({ className = "", disabled = false }: SubmitBtnProps) {
  ...
  return (
    <button
      ...
      disabled={disabled || pending} // ✅ Blokujemy przycisk, jeśli `loading`
    >
      {pending ? (
